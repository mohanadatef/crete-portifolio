...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::get('/admin/custom-reports/{id}/export', [\App\Modules\Lead\Controllers\CustomReportController::class, 'export']);
        ...
        Route::apiResource('/admin/settings/blocked-contacts', \App\Modules\Setting\Controllers\BlockedContactController::class)->only(['index', 'store', 'destroy']);
